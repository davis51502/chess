...
public class PostLoginClient implements ClientObject {
    ...
    public String create(String... params) throws InvalidMoveException {
        if (params.length == 1) {
        ...
        throw new InvalidMoveException(400, "Expected: <NAME>");
    }

    public String list(String... params) throws InvalidMoveException {
    ...
    public String join(String... params) throws InvalidMoveException {
        if (params.length == 2 && (params[1].equals("WHITE") || params[1].equals("BLACK"))){
            ...
            try {
                ...
                throw new InvalidMoveException(400, "Game ID does not exist");
            }
        }
        throw new InvalidMoveException(400, "Expected: <ID> [WHITE|BLACK]");
    }
    public String observe(String... params) throws InvalidMoveException {
        if (params.length == 1){
            try {
                ui.ChessBoard draw = new ui.ChessBoard();
                draw.drawWhite(iDs.get(Integer.parseInt(params[0])).game().getBoard());
                ...
                throw new InvalidMoveException(400, "Game ID not valid");
            }
        }
        throw new InvalidMoveException(400, "Expected: <ID>");
    }

    public String logout(String... params) throws InvalidMoveException {
        server.logout();
        pre = true;
